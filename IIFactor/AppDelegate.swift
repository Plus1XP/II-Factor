...
class AppDelegate: UIResponder, UIApplicationDelegate {
        ...
        func setupContainer() -> NSPersistentContainer {
            ...
            if isCloudKitEnabled {
                ...
                container = NSPersistentCloudKitContainer(name: "IIFactor")
                ...
                container = NSPersistentContainer(name: "IIFactor")
            ...
            func RemoveiCloudData(completion: @escaping (_ response: Bool) -> Void) {
                ...
                let container = CKContainer(identifier: "iCloud.io.plus1xp.IIFactor")
